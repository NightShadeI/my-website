		...
		<div className="skills">
			<Route path="/skills/programming">
				<BannerLeft src="/images/python.png" heading="Python" bgcolour="#1b294b">
					...
					<span>⭐ Rotation calculator. Used by over 80,000 people.</span><br/>
					<span>⭐ Python messenger. Makes use of sockets to message live with others.</span><br/>
					<span>⭐ Load distributor for a distributed network using python.</span><br/>
					<span>⭐ Many of the web applications I have developed use python as a backend. Check them out in the web development section.</span>
				</BannerLeft>
				<BannerRight src="/images/java.png" heading="Java" bgcolour="#610c04">
					<p>Java has been one of the primary languages I have been learning throughout my degree and thus I have much exposure to it. Most of my time spent with it has been around writing object oriented code using design patterns (from the head first design patterns textbook) and I have done some user interface development with it. I have also explored a little mobile application development with it.</p>
			...
			<Route path="/skills/webdev">
				<BannerLeft src="/images/html.png" heading="HTML/CSS/JS" bgcolour="#1b294b">
					...
					<p>⭐ One of my first projects utilising these for front end development was to create a website for a clan of many players I leave within a game. It tracks multiple attributes allowing the clan to be run better. The website can be found here. Username: robinbatty Password: kttass</p>
					<p>⭐ Part of my experience with this also took place at Macquarie bank where I developed Alteryx Smart Analyser with a team of people. The software helps Macquarie bank analyse Alteryx workflows.</p>
				</BannerLeft>
				<BannerRight src="/images/react.png" heading="React" bgcolour="#301934">
					<p>During my 3rd year of university I undertook an elective subject "Advanced web development" to learn more about the world of web development - enjoying it so much. During this time we learnt about the react library for fast web development. The website you are reading here is built from react.</p>
					...
					<span>⭐ Binger. A social media platform like twitter</span><br/>
					<span>⭐ Reproduction simulator. A simulator I made in a group that simulates the spread of disease</span>
				</BannerRight>
				<BannerLeft src="/images/node.png" heading="NodeJS" bgcolour="#610c04">
					<p>In addition to python, I also have experience in NodeJS as well as its library, express for designing backends. All my projects listed above designed with react were also designed using express as a backend.</p>
				</BannerLeft>
			</Route>
			<Route path="/skills/databases">
				<BannerLeft src="/images/SQL.png" heading="MySQL" bgcolour="#1b294b">
					<p>My first exposure to SQL was within my first year of university which I have since incorporated in many projects in various forms. These are forms such as MySQL and SQLite.</p>
					<p>⭐ My primary project which makes use of a 500Mb SQL database (using index's and other query optimisations) is the clan website I host on a platform called pythonanywhere. The website is used to help leaders make informed decisions based on live clan statistics. It can be accessed here with Username: robinbatty Password: kttass</p>
				</BannerLeft>
