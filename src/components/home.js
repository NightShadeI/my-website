...
const Home = () => {
	...
	return (
		<div className="home">
			<video loop autoPlay muted id="stars">
				<source src="/videos/stars.mp4" type="video/mp4"></source>
      		</video>
			<Route path="/home/introductions">
				<div className = "messagebox">
					...
					<Message>
						<span>If you have any quesions, don't hesitate to contact me using the <a href="/contact me">contact me</a> link here or the navigation bar</span>
					</Message>
				</div>
			</Route>
