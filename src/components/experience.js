		...
		<div className="experience">
			<Route path="/experience/jnreng">
				<BannerLeft src="/images/JE.png" heading="Junior Engineers" bgcolour="rgba(27, 41, 75, 0.9)" bgimage="/images/je-bg.jpg">
					<p>This is the company I have been working at since February 2018. Here I mostly content development for their online website called <a href="https://codeflix.com.au/">codeflix</a>. I also teach on at least a weekly basis, more in the holidays where I demonstrate some of my leadership skills.</p>
			...
			<Route path="/experience/mqbank">
				<BannerLeft src="/images/mqbank.png" heading="Macquarie Bank" bgcolour="rgba(0, 0, 0, 0.9)" bgimage="/images/mqbank-bg.jpg">
					<p>During my third year industry project, I worked for Macquarie bank to help them speed up their analysis of Alteryx workflows. I worked within a group of 5 where we communicated together to develop a web application called Alteryx smart analyser. It would read the XML of an Alteryx file and neatly display a summary of it for the user to see.</p>
					<p>The project invovled making a topologically sorted graph which I challenged myself to make without any libraries for maximum control. The final result came out really nicely as shown below.</p>
